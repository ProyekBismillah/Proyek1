  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <ul class="navbar-nav ml-auto ml-md-0">
       <!-- <li class="xn-openable">
                       <a style="color: white;">Hallo , <?php echo $_SESSION['user']; ?></a>
                    </li> -->
        ...
        <div class="row">
          <div class="col-xl-5 col-sm-6 mb-3">
            <div class="card text-white bg-primary o-hidden h-100">
              ...
              <a class="card-footer text-white clearfix small z-1" href="suratMasukSA.php">
          ...
          <div class="col-xl-5 col-sm-6 mb-3">
            <div class="card text-white bg-warning o-hidden h-100">
              ...
              <a class="card-footer text-white clearfix small z-1" href="suratKeluarSA.php">
                <span class="float-left">View Details</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
