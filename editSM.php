            ...
            <div class = "page-content-wrap"></div>
                <div class="container">
                  <?php
                    include 'koneksi.php';
                    $no=$_GET['no'];
                    $query="SELECT * FROM surat_masuk a JOIN kode_agenda b ON a.kode_agenda = b.kode_agenda WHERE a.id_masuk='$no'";
                    $result=mysqli_query($kon, $query);
                    $a = mysqli_query($kon, "SELECT * FROM kode_agenda");
                    while ($row=mysqli_fetch_array($result)) {
                  ?>
                      <form class="well form-horizontal" action="p_editSM.php" method="POST"  id="contact_form" enctype="multipart/form-data">
                  <fieldset>

                  <!-- Form Name -->
                  <legend><center><h2><b>Edit Data Surat Masuk</b></h2></center></legend><br>
                  ...
                  <div class="form-group">
                    ...
                    <input  name="id_masuk" placeholder="" class="form-control"  type="hidden" value="<?php echo $row['id_masuk'];?>">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label class="col-md-10 control-label" >Tanggal Terima</label> 
                      ...
                      <div class="input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                    <input name="tanggal_terima" placeholder="" class="form-control"  type="date" value="<?php echo $row['tanggal_terima'];?>">
                      </div>
                    </div>
                  </div>
