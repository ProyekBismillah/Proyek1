        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class = "page-content-wrap"></div>
                <div class="container">
                      <form class="well form-horizontal" action="p_tambahSKSA.php" method="post"  id="contact_form" enctype="multipart/form-data">
                  <fieldset>

                  <!-- Form Name -->
                  <legend><center><h2><b>Tambah Data Surat Keluar</b></h2></center></legend><br>
